 ...
 */                              
static NSString *const kClientID = @"958032253589-isgn1bpla53ekj1tm7jptbld6lvcrifp.apps.googleusercontent.com";
...
static NSString *const kRedirectURI =
    @"com.googleusercontent.apps.958032253589-isgn1bpla53ekj1tm7jptbld6lvcrifp:/oauthredirect";
...
- (IBAction)authWithAutoCodeExchange:(nullable id)sender {
    ...
    OIDAuthorizationRequest *request =
        [[OIDAuthorizationRequest alloc] initWithConfiguration:configuration
                                                      clientId:kClientID
                                                        scopes:@[OIDScopeOpenID, OIDScopeProfile,OIDScopeEmail,kGTLRAuthScopeCalendar]
